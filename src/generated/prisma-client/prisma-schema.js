...
type Mutation {
  ...
  updateManyFrontDesks(data: FrontDeskUpdateManyMutationInput!, where: FrontDeskWhereInput): BatchPayload!
  upsertFrontDesk(where: FrontDeskWhereUniqueInput!, create: FrontDeskCreateInput!, update: FrontDeskUpdateInput!): FrontDesk!
...
type Query {
  ...
  frontDesks(where: FrontDeskWhereInput, orderBy: FrontDeskOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [FrontDesk]!
  frontDesksConnection(where: FrontDeskWhereInput, orderBy: FrontDeskOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): FrontDeskConnection!
