...
input MessageCreateManyWithoutCommentsInput {
...
input MessageCreateOneWithoutParentInput {
...
input MessageCreateWithoutParentInput {
  id: ID
  title: String!
  text: String!
  author: EmployeeCreateOneWithoutCreatedMessagesInput!
...
input MessageUpdateManyWithoutCommentsInput {
  create: [MessageCreateWithoutCommentsInput!]
  delete: [MessageWhereUniqueInput!]
  connect: [MessageWhereUniqueInput!]
  set: [MessageWhereUniqueInput!]
  disconnect: [MessageWhereUniqueInput!]
  update: [MessageUpdateWithWhereUniqueWithoutCommentsInput!]
  upsert: [MessageUpsertWithWhereUniqueWithoutCommentsInput!]
  deleteMany: [MessageScalarWhereInput!]
  updateMany: [MessageUpdateManyWithWhereNestedInput!]
}
...
input MessageUpdateOneWithoutParentInput {
  create: MessageCreateWithoutParentInput
  update: MessageUpdateWithoutParentDataInput
  upsert: MessageUpsertWithoutParentInput
  delete: Boolean
  disconnect: Boolean
  connect: MessageWhereUniqueInput
}
...
input MessageUpdateWithoutParentDataInput {
  title: String
  text: String
  author: EmployeeUpdateOneRequiredWithoutCreatedMessagesInput
  taggedEmployees: EmployeeUpdateManyWithoutTaggedMessagesInput
...
input MessageUpdateWithWhereUniqueWithoutCommentsInput {
  where: MessageWhereUniqueInput!
...
input MessageUpsertWithoutParentInput {
  update: MessageUpdateWithoutParentDataInput!
  create: MessageCreateWithoutParentInput!
}
...
input MessageUpsertWithWhereUniqueWithoutCommentsInput {
  where: MessageWhereUniqueInput!
